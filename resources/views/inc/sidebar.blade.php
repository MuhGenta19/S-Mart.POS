...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name !=
            'breadcrumb' )
            {{-- @role('admin|pimpinan')
            <li class="menu {{ ($category_name === 'dashboard') ? 'active' : '' }}">
                <a href="/admin" aria-expanded="{{ ($category_name === 'dashboard') ? 'true' : 'false' }}"
            ...
            <li class="menu {{ ($page_name === 'chat') ? 'active' : '' }} md-visible">
                <a href="/apps/chat" aria-expanded="{{ ($page_name === 'chat') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'mailbox') ? 'active' : '' }} md-visible">
                <a href="/apps/mailbox" aria-expanded="{{ ($page_name === 'mailbox') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'todo-list') ? 'active' : '' }} md-visible">
                <a href="/apps/todoList" aria-expanded="{{ ($page_name === 'todo-list') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'notes') ? 'active' : '' }} md-visible">
                <a href="/apps/notes" aria-expanded="{{ ($page_name === 'notes') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'scrumboard') ? 'active' : '' }} md-visible">
                <a href="/apps/scrumboard" aria-expanded="{{ ($page_name === 'scrumboard') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'contacts') ? 'active' : '' }} md-visible">
                <a href="/apps/contacts" aria-expanded="{{ ($page_name === 'contacts') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'invoice') ? 'active' : '' }} md-visible">
                <a href="/apps/invoice" aria-expanded="{{ ($page_name === 'invoice') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($page_name === 'calendar') ? 'active' : '' }} md-visible">
                <a href="/apps/calendar" aria-expanded="{{ ($page_name === 'calendar') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'barang') ? 'active' : '' }}">
                <a href="/admin/barang" aria-expanded="{{ ($category_name === 'barang') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            ...
            <li class="menu {{ ($category_name === 'penjualan') ? 'active' : '' }}">
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'penjualan') ? 'show' : '' }}"
                    id="penjualan" data-parent="#accordionExample">
                    <li class="{{ ($page_name === 'dibayar') ? 'active' : '' }}">
                        <a href="/admin/penjualan/dibayar"> Penjualan </a>
                    </li>
                    <li class="{{ ($page_name === 'belumbayar') ? 'active' : '' }}">
                        <a href="/admin/penjualan/belumbayar"> Keranjang </a>
                    </li>
                </ul>
            </li>
            @endrole
            ...
            <li class="menu {{ ($category_name === 'laporan') ? 'active' : '' }}">
                <a href="/admin/laporan" aria-expanded="{{ ($category_name === 'laporan') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            ...
            <a href="#components" data-toggle="collapse"
                aria-expanded="{{ ($category_name === 'components') ? 'true' : 'false' }}" class="dropdown-toggle">
                <div class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'elements') ? 'active' : '' }}">
                <a href="#elements" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'elements') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'fonticons') ? 'active' : '' }}">
                <a href="/font_icons" aria-expanded="{{ ($category_name === 'fonticons') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'widgets') ? 'active' : '' }}">
                <a href="/widgets" aria-expanded="{{ ($category_name === 'widgets') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'datatable') ? 'active' : '' }}">
                <a href="#datatables" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'datatable') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'forms') ? 'active' : '' }}">
                <a href="#forms" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'forms') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'forms') ? 'show' : '' }}" id="forms"
            ...
            <li class="menu {{ ($category_name === 'users') ? 'active' : '' }}">
                <a href="#users" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'users') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="feather feather-users">
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'users') ? 'show' : '' }}" id="users"
                    data-parent="#accordionExample">
            ...
            <li class="menu {{ ($category_name === 'pages') ? 'active' : '' }}">
                <a href="#pages" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'pages') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ ($category_name === 'pages') ? 'show' : '' }}" id="pages"
                    data-parent="#accordionExample">
                    ...
                    <li class="{{ ($page_name === 'dashboard') ? 'active' : '' }}">
                        <a href="#pages-error" data-toggle="collapse"
                        ...
                        <ul class="collapse list-unstyled {{ ($category_name === 'dashboard') ? 'show' : '' }} sub-submenu"
            ...
            <li class="menu {{ ($category_name === 'auth') ? 'active' : '' }}">
                <a href="#authentication" data-toggle="collapse"
                    aria-expanded="{{ ($category_name === 'auth') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'drag_n_drop') ? 'active' : '' }}">
                <a href="/drag_and_drop" aria-expanded="{{ ($category_name === 'drag_n_drop') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'maps') ? 'active' : '' }}">
                <a href="/maps" aria-expanded="{{ ($category_name === 'maps') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ ($category_name === 'charts') ? 'active' : '' }}">
                <a href="/charts" aria-expanded="{{ ($category_name === 'charts') ? 'true' : 'false' }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
