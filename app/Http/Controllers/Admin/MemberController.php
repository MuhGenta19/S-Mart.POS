...
class MemberController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        if ($member != null) {
            return back()->withToastError('this user is already registered as a member');
        } else {
            Member::create($params);
            return back()->withToastSuccess('topup successful');
        }
    ...
    public function destroy($id)
    {
        ...
        return back()->withToastSuccess('successfully deleted member');
    }
}
